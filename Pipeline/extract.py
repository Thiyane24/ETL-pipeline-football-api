#Extract file extracts the api for the top scorers from 2024, flattens the nested JSON, builds a dataframe and saves it to parquet with load_id 
import requests
import os
...
if response.status_code == 200:
    ...
    raise NameError("Status is not 200")
